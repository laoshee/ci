...
<body >
  ...
  <nav class="nav-extended">
      <div class="nav-wrapper">
        <a href="#" class="brand-logo"><img src="https://bayoe.id/wp-content/uploads/2020/05/logo-bayoe_id.png" alt="logo"/></a> <!-- <link rel="shortcut icon" type="image/x-icon" href="<?php echo base_url('uploads/'); ?><?php echo get_option('site_logo'); ?>"alt="logo"/>LOGO</a> -->
        ...
        <ul id="nav-mobile" class="right hide-on-med-and-down">
                ...
                <li class="tab">
                Cart(<?php echo $this->cart->total_items();?> Items) &nbsp;
                  </li>
