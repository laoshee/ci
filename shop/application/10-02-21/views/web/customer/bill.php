        ...
        <tbody>
            ...
            foreach ($cart_contents as $cart_items) {
                ...
                <tr>
                    ...
                    <td style="width:100px"><img src="<?php echo base_url('assets/uploads/' . $cart_items['options']['product_image']) ?>" alt="" style="width:75%"/></td>
                    <td>Rp. 
                    ...
                    <td><input type="number" name="<?=$i.'[qty]';?>" class="itemQty" min="1" id="" value="<?= $cart_items['qty'] ?>"/>  
                    </td>
                    <!-- <td>
...
<?php } else {  echo "<center><h1>Your Bill Empty</h1></center>"; } ?>